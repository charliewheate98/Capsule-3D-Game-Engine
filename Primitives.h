...
public:
	inline Primitives() = default;
	~Primitives() {}

	static inline void sphere()
	{
...
GLuint Primitives::sphereVAO;
GLuint Primitives::indexCount;

GLuint Primitives::cubeVAO;
GLuint Primitives::cubeVBO;
